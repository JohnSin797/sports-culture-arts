...
<body>
    ...
    <main class="container">
        <section class="panel">
            ...
            <form method="POST" action="../../api/add-equipment-stock.php">
                <?php
                    if ($_SESSION['Usertype'] === 'Admin') {
                        echo '<input type="hidden" name="tblaccount_id" value="'.$_SESSION['id'].'" >';
                    }
                ?>
                ...
                <div class="panelbody">
                    ...
                    <input type="number" style="width:100%;border-radius:0.25rem;padding:0.5rem;font-size:0.875rem;line-height:1.25rem;margin-bottom:0.5rem;" name="quantity" id="quantity" required>
                </div>
    ...
    <?php if (isset($_GET['responseMessage'])): ?>
        <script>
            alert("<?php echo htmlspecialchars($_GET['responseMessage']); ?>");
        </script>
    <?php endif; ?>
</body>
</html>